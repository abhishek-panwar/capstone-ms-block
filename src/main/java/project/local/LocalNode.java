...
public class LocalNode {
	...
	private int successCount; //number of accepted transactions 
	private int failureCount; //number of rejected transactions
	...
	/* gives access to local node/smart home
	 * 
	 */
	public void access()
	{
	...
	/*
	 * verifies if blockchain is valid
	 */
	...
	/**
	 * creates a local transaction object
	 * @param requesterID
	 * @param type
	 * @param requesteeID
	 * @return
	...
	/**
	 * create multi-sig transaction object
	 * @param requesterID
	 * @param requesteeID
	 * @return
	 */
	...
	/**
	 * generates reputation for current node
	 * @return
	 */
	...
	/**
	 * policies at run time are set here
	 */
	...
	/**
	 * adds policy to the policy header
	 * @param requesterID
	 * @param type
	 * @param requesteeID
	 * @param action
	...
	/**
	 * a block can be altered to check if the blockchain is valid or not
	 */
	...
	/**
	 * verifies multi-sig transaction
	 * @param transaction
	 */
