...
public class OverlayNode {
	...
	/**
	 * adds transaction to the transactions pool
	 * @param id
	 */
	...
	/**
	 * a multi-sig transaction is taken care here at OBM level
	 * @param transaction
	 * @return
	 */
	...
	/**
	 * transaction is broadcasted in the local cluster of OBM
	 * @param transaction
	 * @return
	 */
	...
	/**
	 * a multi-sig transaction is added to the block
	 * @param transaction
	 */
